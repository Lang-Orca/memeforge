...
export default function ImageGeneratorScreen({ navigation }: Props) {
  ...
  function onGenerate() {
    if (!text.trim()) {
      Alert.alert('Image requise', 'Veuillez saisir une description d’image.');
      return;
    }
    navigation.navigate('MemeResultScreen', { memeUrl: 'https://via.placeholder.com/1024x1024.png?text=Memeforge+Image', source: 'image' });
  }
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <Text style={styles.subtitle}>Décrivez l’image de base pour générer un mème.</Text>
